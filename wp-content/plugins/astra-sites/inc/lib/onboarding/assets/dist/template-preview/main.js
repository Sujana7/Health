( () => {
    ...
    ( () => {
          ...
          , i = e => {
            ...
            case "siteLogo":
                ...
                0 === t.length && "" !== a) {
                    ...
                    "" !== l && (n.style.width = l + "px",
                    n.style.maxWidth = l + "px")
                } else if ("" !== a)
                    for (const [o,n] of Object.entries(t)) {
                        n.removeAttribute("srcset"),
                        n.setAttribute("src", a);
                        const t = e.value.data.width;
                        "" !== t && (n.style.width = t + "px",
                        n.style.maxWidth = t + "px")
                    }
                break;
            case "colorPalette":
            ...
            case "siteTypography":
                ...
                (e => {
                    ...
                    ["h1", "h2", "h3", "h4", "h5", "h6"].forEach((t => {
                        ...
                        let r = "";
                        void 0 !== o && "" !== o && (r += `${t}, .entry-content ${t} {`,
                        r += "\tfont-family: " + o + ";"),
                        void 0 !== e["line-height-" + t] && "" !== e["line-height-" + t] && (r += "\tline-height: " + e["line-height-" + t] + ";"),
                        void 0 !== n && "" !== n && (r += "\tfont-weight: " + n + ";"),
                        a += "" !== r ? r + "}" : ""
                    }
                    )),
                    t.innerHTML = a
        ...
        window.addEventListener("message", (function(e) {
            if (o() && (console.log("addEventListener message: ", e),
            "object" == typeof e.data && "starterTemplatePreviewDispatch" === e.data.call)) {
                const t = e.data;
        ...
        a()(( () => {
            ...
            e.innerHTML = ".site-logo-img img { transition: unset; } #wpadminbar { display: none; } html{  margin-top: 0 !important; }}";
            const t = (a = n,
