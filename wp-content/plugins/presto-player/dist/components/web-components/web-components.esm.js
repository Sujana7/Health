import {p as e, b as t} from "./p-43f79dfb.js";
export {s as setNonce} from "./p-43f79dfb.js";
import {g as a} from "./p-e1255160.js";
const r = () => {
    const t = import.meta.url
      , a = {};
    return "" !== t && (a.resourcesUrl = new URL(".",t).href),
    e(a)
}
;
r().then((async e => (await a(),
t([["p-4d245ebe", [[1, "presto-playlist", {
    items: [16],
    heading: [1],
    ...
    currentPlyr: [32],
    playing: [32]
}, [[0, "rewatch", "rewatch"], [0, "next", "next"]], {
    currentPlyr: ["handleCurrentPlay"]
}]]], ["p-ffab5a11", [[1, "presto-player-skeleton", {
    effect: [1]
}]]], ["p-accbf9cd", [[4, "presto-timestamp", {
    time: [1]
}]]], ["p-ba1dc20e", [[1, "presto-video-curtain-ui", {
    actionUrl: [1, "action-url"]
}]]], ["p-b3731d50", [[1, "presto-search-bar-ui", {
    value: [1025],
    placeholder: [1],
...
}]]], ["p-5dfd1438", [[1, "presto-player-button", {
    type: [513],
    size: [513],
    full: [516],
    disabled: [516],
    ...
    hasPrefix: [32],
    hasSuffix: [32]
}]]], ["p-892f7c14", [[1, "presto-cta-overlay-ui", {
    headline: [1],
    ...
    provider: [1],
    videoAttributes: [16]
}]]], ["p-9dc09eba", [[1, "presto-action-bar-ui", {
    open: [4]
}], [0, "presto-youtube-subscribe-button", {
    channel: [1],
    layout: [1],
    showCount: [4, "show-count"]
}]]], ["p-0665e072", [[1, "presto-email-overlay-ui", {
    headline: [1],
    bottomText: [1, "bottom-text"],
    buttonText: [1, "button-text"],
    allowSkip: [4, "allow-skip"],
    ...
    email: [32],
    isAudioProvider: [32]
}], [1, "presto-player-spinner"]]], ["p-100fe3ec", [[1, "presto-action-bar", {
    player: [8],
    config: [16],
    direction: [1],
    youtube: [16],
    ...
    audioAttributes: [16],
    width: [32]
}], [4, "presto-business-skin"], [4, "presto-modern-skin"], [0, "presto-muted-overlay", {
    mutedPreview: [4, "muted-preview"],
    mutedOverlay: [16],
    preset: [16]
}], [4, "presto-stacked-skin"], [0, "presto-vimeo", {
    src: [1],
    poster: [1],
    player: [8],
    getRef: [1040]
    ...
    once: [64],
    off: [64]
}, [[8, "currentMediaPlayer", "handleScroll"], [0, "restartVideo", "handleRestartVideo"], [0, "playVideo", "handlePlayVideo"], [0, "pauseVideo", "handlePauseVideo"], [8, "visibilitychange", "playVideoOnlyInViewport"], [0, "ctaStateChange", "handleCtaStateChange"], [0, "emailStateChange", "handleEmailStateChange"], [0, "actionBarStateChange", "handleActionBarStateChange"]], {
